...
import static io.bitcoinsv.bitcoinjsv.utils.BtcAutoFormat.Style.CODE;
import static io.bitcoinsv.bitcoinjsv.utils.BtcAutoFormat.Style.SYMBOL;
import static io.bitcoinsv.bitcoinjsv.utils.BtcFixedFormat.REPEATING_DOUBLETS;
import static io.bitcoinsv.bitcoinjsv.utils.BtcFixedFormat.REPEATING_TRIPLETS;
...
public class BtcFormatTest {
    ...
    public void prefixTest() { // prefix b/c symbol is prefixed
        ...
        assertEquals("฿1.00", usFormat.format(Coin.COIN));
    ...
    public void symbolCollisionTest() {
        ...
        for (int i = 0; i < locales.length; ++i) {
            ...
            if (cs.contains("฿")) {
                ...
                String coin = bf.format(Coin.COIN);
                assertTrue(coin.contains("Ƀ"));
                assertFalse(coin.contains("฿"));
                String milli = bf.format(Coin.valueOf(10000));
                assertTrue(milli.contains("₥Ƀ"));
                assertFalse(milli.contains("฿"));
                String micro = bf.format(Coin.valueOf(100));
                ...
                milli = mlff.format(Coin.valueOf(10000));
                assertTrue(milli.contains("₥Ƀ"));
                assertFalse(milli.contains("฿"));
                ...
                micro = mcff.format(Coin.valueOf(100));
                assertTrue(micro.contains("µɃ"));
                assertFalse(micro.contains("฿"));
            }
    ...
    public void argumentTypeTest() {
        ...
        // Coin
        assertEquals("µ฿1,000,000.01", usFormat.format(Coin.COIN.add(Coin.valueOf(1))));
        // Integer
    ...
    public void columnAlignmentTest() {
        ...
        Coin[] rows = {MAX_MONEY, MAX_MONEY.subtract(Coin.SATOSHI), Coin.parseCoin("1234"),
                       Coin.COIN, Coin.COIN.add(Coin.SATOSHI), Coin.COIN.subtract(Coin.SATOSHI),
                        Coin.COIN.divide(1000).add(Coin.SATOSHI), Coin.COIN.divide(1000), Coin.COIN.divide(1000).subtract(Coin.SATOSHI),
                       Coin.valueOf(100), Coin.valueOf(1000), Coin.valueOf(10000),
                       Coin.SATOSHI};
    ...
    public void repeatingPlaceTest() {
        ...
        Coin value = MAX_MONEY.subtract(Coin.SATOSHI);
        ...
        assertEquals("1.00000005", BtcFormat.getCoinInstance(US).
                                   format(Coin.COIN.add(Coin.valueOf(5)), 0, BtcFixedFormat.REPEATING_PLACES));
    }

    @Test
    public void characterIteratorTest() {
        BtcFormat usFormat = BtcFormat.getInstance(Locale.US);
        AttributedCharacterIterator i = usFormat.formatToCharacterIterator(Coin.parseCoin("1234.5"));
        ...
        fa.formatToCharacterIterator(Coin.COIN.multiply(1000000));
        assertEquals(fa, fb);
        assertEquals(fa.hashCode(), fb.hashCode());
        fb.formatToCharacterIterator(Coin.COIN.divide(1000000));
        assertEquals(fa, fb);
        assertEquals(fa.hashCode(), fb.hashCode());
    }
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(Coin.valueOf(200000000), us.parseObject("BTC2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("XBT2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("฿2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("Ƀ2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("BTC 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("฿2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("Ƀ2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("BTC2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("XBT2.0"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("฿ 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("Ƀ 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject(" 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("BTC 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("฿2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("Ƀ2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("BTC2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("XBT2,022,224.20"));
        assertEquals(Coin.valueOf(220200000000L), us.parseObject("2,202.0"));
        assertEquals(Coin.valueOf(2100000000000000L), us.parseObject("21000000.00000000"));
        // MilliCoins
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mBTC 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mXBT 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("m฿ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mɃ 2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("mBTC2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("mXBT2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥฿2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥Ƀ2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥BTC 2.00"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XBT 2.00"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥BTC 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XBT 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥฿ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥Ƀ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥ 2"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥฿2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), us.parseObject("₥Ƀ2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("m฿2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), us.parseObject("mɃ2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥BTC2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥XBT2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("mBTC2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("mXBT2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), us.parseObject("₥2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥฿ 2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), usCoded.parseObject("₥Ƀ 2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("m฿ 2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), usCoded.parseObject("mɃ 2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥BTC 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥XBT 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("mBTC 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("mXBT 2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), usCoded.parseObject("₥ 2,022,224.20"));
        // Microcoins
        assertEquals(Coin.valueOf(435), us.parseObject("µ฿4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uɃ4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("u฿4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µɃ4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uBTC4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µBTC4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µXBT4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("uBTC 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("µBTC 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("µXBT 4.35"));
        // fractional satoshi; round up
        assertEquals(Coin.valueOf(435), us.parseObject("uBTC4.345"));
        assertEquals(Coin.valueOf(435), us.parseObject("uXBT4.345"));
        // negative with mu symbol
        assertEquals(Coin.valueOf(-1), usCoded.parseObject("(µ฿ 0.01)"));
        assertEquals(Coin.valueOf(-10), us.parseObject("(µBTC0.100)"));
        assertEquals(Coin.valueOf(-10), us.parseObject("(µXBT0.100)"));
        ...
        usCoded = BtcFormat.builder().locale(US).scale(0).symbol("£").code("XYZ").
                            pattern("¤ #,##0.00").build();
        // Coins
        assertEquals(Coin.valueOf(200000000), us.parseObject("XYZ2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("BTC2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("XBT2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("£2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("฿2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("Ƀ2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("XYZ 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("BTC 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("XBT 2"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("£2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("฿2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("Ƀ2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("XYZ2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("BTC2.0"));
        assertEquals(Coin.valueOf(200000000), us.parseObject("XBT2.0"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("£ 2"));
        assertEquals(Coin.valueOf(200000000), usCoded.parseObject("฿ 2"));
        ...
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("฿2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("Ƀ2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("XYZ2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("BTC2,022,224.20"));
        assertEquals(Coin.valueOf(202222420000000L), us.parseObject("XBT2,022,224.20"));
        assertEquals(Coin.valueOf(220200000000L), us.parseObject("2,202.0"));
        assertEquals(Coin.valueOf(2100000000000000L), us.parseObject("21000000.00000000"));
        // MilliCoins
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mXYZ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mBTC 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mXBT 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("m£ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("m฿ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("mɃ 2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("mXYZ2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("mBTC2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("mXBT2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥£2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥฿2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥Ƀ2"));
        assertEquals(Coin.valueOf(200000), us.parseObject("₥2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XYZ 2.00"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥BTC 2.00"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XBT 2.00"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XYZ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥BTC 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥XBT 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥£ 2"));
        assertEquals(Coin.valueOf(200000), usCoded.parseObject("₥฿ 2"));
        ...
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("m฿2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), us.parseObject("mɃ2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥XYZ2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥BTC2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("₥XBT2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("mXYZ2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("mBTC2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), us.parseObject("mXBT2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), us.parseObject("₥2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥£ 2,022,224"));
        ...
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("m฿ 2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), usCoded.parseObject("mɃ 2,022,224.20"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥XYZ 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥BTC 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("₥XBT 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("mXYZ 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("mBTC 2,022,224"));
        assertEquals(Coin.valueOf(202222400000L), usCoded.parseObject("mXBT 2,022,224"));
        assertEquals(Coin.valueOf(202222420000L), usCoded.parseObject("₥ 2,022,224.20"));
        // Microcoins
        ...
        assertEquals(Coin.valueOf(435), us.parseObject("u฿4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µɃ4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uXYZ4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uBTC4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µXYZ4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µBTC4.35"));
        assertEquals(Coin.valueOf(435), us.parseObject("µXBT4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("uXYZ 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("uBTC 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("µXYZ 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("µBTC 4.35"));
        assertEquals(Coin.valueOf(435), usCoded.parseObject("µXBT 4.35"));
        // fractional satoshi; round up
        assertEquals(Coin.valueOf(435), us.parseObject("uXYZ4.345"));
        assertEquals(Coin.valueOf(435), us.parseObject("uBTC4.345"));
        assertEquals(Coin.valueOf(435), us.parseObject("uXBT4.345"));
        // negative with mu symbol
        assertEquals(Coin.valueOf(-1), usCoded.parseObject("µ£ -0.01"));
        assertEquals(Coin.valueOf(-1), usCoded.parseObject("µ฿ -0.01"));
        assertEquals(Coin.valueOf(-10), us.parseObject("(µXYZ0.100)"));
        assertEquals(Coin.valueOf(-10), us.parseObject("(µBTC0.100)"));
        assertEquals(Coin.valueOf(-10), us.parseObject("(µXBT0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(Coin.parseCoin("1"), cp.parseObject("BTC 1.00"));
        assertEquals(Coin.parseCoin("1"), sp.parseObject("BTC1.00"));
        assertEquals(Coin.parseCoin("1"), cp.parseObject("฿ 1.00"));
        assertEquals(Coin.parseCoin("1"), sp.parseObject("฿1.00"));
        assertEquals(Coin.parseCoin("1"), cp.parseObject("B⃦ 1.00"));
        assertEquals(Coin.parseCoin("1"), sp.parseObject("B⃦1.00"));
        assertEquals(Coin.parseCoin("1"), cp.parseObject("Ƀ 1.00"));
        assertEquals(Coin.parseCoin("1"), sp.parseObject("Ƀ1.00"));
        // milli
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("mBTC 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("mBTC1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("m฿ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("m฿1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("mB⃦ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("mB⃦1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("mɃ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("mɃ1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("₥BTC 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("₥BTC1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("₥฿ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("₥฿1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("₥B⃦ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("₥B⃦1.00"));
        assertEquals(Coin.parseCoin("0.001"), cp.parseObject("₥Ƀ 1.00"));
        assertEquals(Coin.parseCoin("0.001"), sp.parseObject("₥Ƀ1.00"));
        // micro
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("uBTC 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("uBTC1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("u฿ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("u฿1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("uB⃦ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("uB⃦1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("uɃ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("uɃ1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("µBTC 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("µBTC1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("µ฿ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("µ฿1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("µB⃦ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("µB⃦1.00"));
        assertEquals(Coin.parseCoin("0.000001"), cp.parseObject("µɃ 1.00"));
        assertEquals(Coin.parseCoin("0.000001"), sp.parseObject("µɃ1.00"));
        // satoshi
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("uBTC 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("uBTC0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("u฿ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("u฿0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("uB⃦ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("uB⃦0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("uɃ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("uɃ0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("µBTC 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("µBTC0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("µ฿ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("µ฿0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("µB⃦ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("µB⃦0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), cp.parseObject("µɃ 0.01"));
        assertEquals(Coin.parseCoin("0.00000001"), sp.parseObject("µɃ0.01"));
        // cents
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("cBTC 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("cBTC1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("c฿ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("c฿1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("cB⃦ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("cB⃦1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("cɃ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("cɃ1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("¢BTC 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("¢BTC1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("¢฿ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("¢฿1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("¢B⃦ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("¢B⃦1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), cp.parseObject("¢Ƀ 1.234567"));
        assertEquals(Coin.parseCoin("0.01234567"), sp.parseObject("¢Ƀ1.234567"));
        // dekacoins
        assertEquals(Coin.parseCoin("12.34567"), cp.parseObject("daBTC 1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), sp.parseObject("daBTC1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), cp.parseObject("da฿ 1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), sp.parseObject("da฿1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), cp.parseObject("daB⃦ 1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), sp.parseObject("daB⃦1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), cp.parseObject("daɃ 1.234567"));
        assertEquals(Coin.parseCoin("12.34567"), sp.parseObject("daɃ1.234567"));
        // hectocoins
        assertEquals(Coin.parseCoin("123.4567"), cp.parseObject("hBTC 1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), sp.parseObject("hBTC1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), cp.parseObject("h฿ 1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), sp.parseObject("h฿1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), cp.parseObject("hB⃦ 1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), sp.parseObject("hB⃦1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), cp.parseObject("hɃ 1.234567"));
        assertEquals(Coin.parseCoin("123.4567"), sp.parseObject("hɃ1.234567"));
        // kilocoins
        assertEquals(Coin.parseCoin("1234.567"), cp.parseObject("kBTC 1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), sp.parseObject("kBTC1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), cp.parseObject("k฿ 1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), sp.parseObject("k฿1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), cp.parseObject("kB⃦ 1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), sp.parseObject("kB⃦1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), cp.parseObject("kɃ 1.234567"));
        assertEquals(Coin.parseCoin("1234.567"), sp.parseObject("kɃ1.234567"));
        // megacoins
        assertEquals(Coin.parseCoin("1234567"), cp.parseObject("MBTC 1.234567"));
        assertEquals(Coin.parseCoin("1234567"), sp.parseObject("MBTC1.234567"));
        assertEquals(Coin.parseCoin("1234567"), cp.parseObject("M฿ 1.234567"));
        assertEquals(Coin.parseCoin("1234567"), sp.parseObject("M฿1.234567"));
        assertEquals(Coin.parseCoin("1234567"), cp.parseObject("MB⃦ 1.234567"));
        assertEquals(Coin.parseCoin("1234567"), sp.parseObject("MB⃦1.234567"));
        assertEquals(Coin.parseCoin("1234567"), cp.parseObject("MɃ 1.234567"));
        assertEquals(Coin.parseCoin("1234567"), sp.parseObject("MɃ1.234567"));
    }
    ...
    public void parsePositionTest() {
        ...
        assertEquals(
          "987,654,321",
          usCoded.format(Coin.valueOf(98765432123L), new StringBuffer(), intField).
        ...
        assertEquals(
          "23",
          usCoded.format(Coin.valueOf(98765432123L), new StringBuffer(), fracField).
        ...
        assertEquals(
          "µ฿",
          de.format(Coin.valueOf(98765432123L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
        assertEquals(
          "µBTC",
          deCoded.format(Coin.valueOf(98765432123L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
        assertEquals(
          "₥฿",
          de.format(Coin.valueOf(98765432000L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
        assertEquals(
          "mBTC",
          deCoded.format(Coin.valueOf(98765432000L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
        assertEquals(
          "฿",
          de.format(Coin.valueOf(98765000000L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
        assertEquals(
          "BTC",
          deCoded.format(Coin.valueOf(98765000000L), new StringBuffer(), currField).
          substring(currField.getBeginIndex(), currField.getEndIndex())
        );
    }
    ...
    public void currencyCodeTest() {
        ...
        assertEquals("BTC 1.00", usCoded.format(Coin.COIN));
        ...
        assertEquals("1,00 BTC", frCoded.format(Coin.COIN));
        ...
        assertEquals("BTC 1,00", deCoded.format(Coin.COIN));
    }
    ...
    public void coinScaleTest() throws Exception {
        ...
        assertEquals(Coin.valueOf(1000000), coinFormat.parseObject("0.01"));
    ...
    public void millicoinScaleTest() throws Exception {
        ...
        assertEquals(Coin.valueOf(1000), coinFormat.parseObject("0.01"));
    ...
    public void microcoinScaleTest() throws Exception {
        ...
        assertEquals("1,000,000.10", coinFormat.format(Coin.COIN.add(Coin.valueOf(10))));
        assertEquals(Coin.parseCoin("0.000001"), coinFormat.parseObject("1.00"));
        assertEquals(Coin.valueOf(1), coinFormat.parseObject("0.01"));
    ...
    public void factoryTest() {
        ...
        try {
            BtcFormat.getInstance(Coin.SMALLEST_UNIT_EXPONENT + 1);
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("฿1", symbolZero.format(Coin.COIN));
        assertEquals("BTC 1", codedZero.format(Coin.COIN));
        assertEquals("µ฿1,000,000", symbolZero.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("µBTC 1,000,000", codedZero.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("µ฿1,000,000", symbolZero.format(Coin.COIN.subtract(Coin.valueOf(50))));
        assertEquals("µBTC 1,000,000", codedZero.format(Coin.COIN.subtract(Coin.valueOf(50))));
        assertEquals("µ฿999,999", symbolZero.format(Coin.COIN.subtract(Coin.valueOf(51))));
        assertEquals("µBTC 999,999", codedZero.format(Coin.COIN.subtract(Coin.valueOf(51))));
        assertEquals("฿1,000", symbolZero.format(Coin.COIN.multiply(1000)));
        assertEquals("BTC 1,000", codedZero.format(Coin.COIN.multiply(1000)));
        ...
        assertEquals("฿1.00", symbolTwo.format(Coin.COIN));
        assertEquals("BTC 1.00", codedTwo.format(Coin.COIN));
        assertEquals("µ฿999,999.99", symbolTwo.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("µBTC 999,999.99", codedTwo.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("฿1,000.00", symbolTwo.format(Coin.COIN.multiply(1000)));
        assertEquals("BTC 1,000.00", codedTwo.format(Coin.COIN.multiply(1000)));
        ...
        assertEquals("฿1.000", symbolThree.format(Coin.COIN));
        assertEquals("BTC 1.000", codedThree.format(Coin.COIN));
        assertEquals("µ฿999,999.99", symbolThree.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("µBTC 999,999.99", codedThree.format(Coin.COIN.subtract(Coin.SATOSHI)));
        assertEquals("฿1,000.000", symbolThree.format(Coin.COIN.multiply(1000)));
        assertEquals("BTC 1,000.000", codedThree.format(Coin.COIN.multiply(1000)));
    ...
    public void btcRounding() throws Exception {
        BtcFormat coinFormat = BtcFormat.getCoinInstance(Locale.US);
        assertEquals("0", BtcFormat.getCoinInstance(Locale.US, 0).format(Coin.ZERO));
        assertEquals("0", coinFormat.format(Coin.ZERO, 0));
        assertEquals("0.00", BtcFormat.getCoinInstance(Locale.US, 2).format(Coin.ZERO));
        assertEquals("0.00", coinFormat.format(Coin.ZERO, 2));

        assertEquals("1", BtcFormat.getCoinInstance(Locale.US, 0).format(Coin.COIN));
        assertEquals("1", coinFormat.format(Coin.COIN, 0));
        assertEquals("1.0", BtcFormat.getCoinInstance(Locale.US, 1).format(Coin.COIN));
        assertEquals("1.0", coinFormat.format(Coin.COIN, 1));
        assertEquals("1.00", BtcFormat.getCoinInstance(Locale.US, 2, 2).format(Coin.COIN));
        assertEquals("1.00", coinFormat.format(Coin.COIN, 2, 2));
        assertEquals("1.00", BtcFormat.getCoinInstance(Locale.US, 2, 2, 2).format(Coin.COIN));
        assertEquals("1.00", coinFormat.format(Coin.COIN, 2, 2, 2));
        assertEquals("1.00", BtcFormat.getCoinInstance(Locale.US, 2, 2, 2, 2).format(Coin.COIN));
        assertEquals("1.00", coinFormat.format(Coin.COIN, 2, 2, 2, 2));
        assertEquals("1.000", BtcFormat.getCoinInstance(Locale.US, 3).format(Coin.COIN));
        assertEquals("1.000", coinFormat.format(Coin.COIN, 3));
        assertEquals("1.0000", BtcFormat.getCoinInstance(US, 4).format(Coin.COIN));
        assertEquals("1.0000", coinFormat.format(Coin.COIN, 4));
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 BTC", BtcFormat.getInstance(FRANCE).format(Coin.COIN.multiply(-1)));
        assertEquals("BTC -1,00", BtcFormat.getInstance(ITALY).format(Coin.COIN.multiply(-1)));
        assertEquals("฿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(Coin.COIN.multiply(-1)));
        assertEquals("BTC -1.00", BtcFormat.getInstance(JAPAN).format(Coin.COIN.multiply(-1)));
        assertEquals("฿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(Coin.COIN.multiply(-1)));
        assertEquals("(BTC 1.00)", BtcFormat.getInstance(US).format(Coin.COIN.multiply(-1)));
        assertEquals("(฿1.00)", BtcFormat.getSymbolInstance(US).format(Coin.COIN.multiply(-1)));
        // assertEquals("BTC -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("BTC -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(Coin.COIN.multiply(-1)));
        assertEquals("Ƀ-๑.๐๐", BtcFormat.getSymbolInstance(new Locale("th","TH","TH")).format(Coin.COIN.multiply(-1)));
    }
    ...
    public void equalityTest() throws Exception {
        ...
        a.format(Coin.COIN.multiply(1000000));
        assertEquals(a, b);
        assertEquals(a.hashCode(), b.hashCode());
        b.format(Coin.COIN.divide(1000000));
        assertEquals(a, b);
        assertEquals(a.hashCode(), b.hashCode());
        // when parsing
        ...
        assertNotEquals(BtcFormat.getInstance(Coin.SMALLEST_UNIT_EXPONENT),
                        BtcFormat.getInstance(Coin.SMALLEST_UNIT_EXPONENT - 1));
        assertNotEquals(BtcFormat.getInstance(Coin.SMALLEST_UNIT_EXPONENT).hashCode(),
                        BtcFormat.getInstance(Coin.SMALLEST_UNIT_EXPONENT - 1).hashCode());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("mBTC 1000.000", f.format(Coin.COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("100.0000,00", built.format(Coin.COIN));
        built = BtcFormat.builder().pattern("#,####.#").scale(6).locale(GERMANY).build();
        assertEquals("-100.0000,00", built.format(Coin.COIN.multiply(-1)));
        ...
        assertEquals("฿-1,00", built.format(Coin.COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤ #,####.#").style(SYMBOL).locale(GERMANY).build();
        assertEquals("BTC -1,00", built.format(Coin.COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mBTC1,000.00", built.format(Coin.COIN));
        built = BtcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();
        assertEquals("₥฿ 1,000.00", built.format(Coin.COIN));

        try {
            BtcFormat.builder().pattern("¤¤##,###.#").scale(4).locale(US).build().format(Coin.COIN);
            fail("Pattern with currency sign and non-standard denomination should raise exception");
        } catch (IllegalStateException e) {}

        try {
            BtcFormat.builder().localizedPattern("¤¤##,###.#").scale(4).locale(US).build().format(Coin.COIN);
        ...
        assertEquals("B⃦1.00", built.format(Coin.COIN));
        built = BtcFormat.builder().style(CODE).code("XBT").locale(US).build();
        assertEquals("XBT 1.00", built.format(Coin.COIN));
        built = BtcFormat.builder().style(SYMBOL).symbol("$").locale(GERMANY).build();
        assertEquals("1,00 $", built.format(Coin.COIN));
        ...
        built = BtcFormat.builder().style(SYMBOL).symbol("B\u20e6").locale(US).build();
        assertEquals("₥B⃦1.00", built.format(Coin.COIN.divide(1000)));
        built = BtcFormat.builder().style(CODE).code("XBT").locale(US).build();
        assertEquals("mXBT 1.00", built.format(Coin.COIN.divide(1000)));

        built = BtcFormat.builder().style(SYMBOL).symbol("B\u20e6").locale(US).build();
        assertEquals("µB⃦1.00", built.format(Coin.valueOf(100)));
        built = BtcFormat.builder().style(CODE).code("XBT").locale(US).build();
        assertEquals("µXBT 1.00", built.format(Coin.valueOf(100)));
        ...
        assertEquals("#0฿-1.00", built.format(Coin.COIN.multiply(-1)));
        ...
        assertEquals("#0E#฿-1.00", built.format(Coin.COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0''#'¤#0").scale(0).locale(US).build();
        assertEquals("E#0'#฿-1.00", built.format(Coin.COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0#'¤#0").scale(0).locale(US).build();
        assertEquals("E#0#฿-1.00", built.format(Coin.COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("E'#0''''#'¤#0").scale(0).locale(US).build();
        assertEquals("E#0''#฿-1.00", built.format(Coin.COIN.multiply(-1)));
