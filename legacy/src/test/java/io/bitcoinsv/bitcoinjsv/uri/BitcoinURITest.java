...
public class BitcoinURITest {
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        assertEquals("test:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage",
             BitcoinURI.convertToBitcoinURI(Address.fromBase58(alternativeParameters, MAINNET_GOOD_ADDRESS), Coin.parseCoin("12.34"), "Hello", "AMessage"));
    }
    ...
    public void testGood_Amount() throws BitcoinURIParseException {
        ...
        Assert.assertEquals("654321012345678", testObject.getAmount().toString());

        // Test the decimal parsing
        testObject = new BitcoinURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?amount=.12345678");
        Assert.assertEquals("12345678", testObject.getAmount().toString());

        // Test the integer parsing
        testObject = new BitcoinURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?amount=6543210");
        Assert.assertEquals("654321000000000", testObject.getAmount().toString());
    }
    ...
    public void brokenURIs() throws BitcoinURIParseException {
        ...
        Assert.assertEquals(Coin.CENT, uri.getAmount());
    }
