...
import io.bitcoinsv.bitcoinjsv.msg.BitcoinSerializer;
import io.bitcoinsv.bitcoinjsv.msg.Message;
import io.bitcoinsv.bitcoinjsv.msg.MessageSerializer;
import io.bitcoinsv.bitcoinjsv.msg.p2p.AddressMessage;
import io.bitcoinsv.bitcoinjsv.msg.p2p.HeadersMessage;
...
public class BitcoinSerializerTest {
    private static final byte[] ADDRESS_MESSAGE_BYTES = Utils.HEX.decode("e3e1f3e86164647200000000000000001f000000" +
            "ed52399b01e215104d010000000000000000000000000000000000ffff0a000001208d");

    private static final byte[] TRANSACTION_MESSAGE_BYTES = Utils.HEX.withSeparator(" ", 2).decode(
    ...
    public void testLazyParsing()  throws Exception {
        MessageSerializer bs = Serializer.get(Net.MAINNET, true, false);
    ...
    public void testCachedParsing() throws Exception {
        MessageSerializer serializer = Serializer.get(Net.MAINNET, true, false);
    ...
    public void testHeaders1() throws Exception {
        MessageSerializer serializer = Serializer.defaultFor(Net.MAINNET);

        byte[] headersMessageBytes = Utils.HEX.decode("e3e1f3e8686561" +
        ...
        Assert.assertEquals("0e3e2357e806b6cdb1f70b54c3a3a17b6714ee1f0e68bebb44a74b1efd512098", Utils.HEX.encode(block.getMerkleRoot().getBytes()));
    ...
    public void testHeaders2() throws Exception {
        ...
        byte[] headersMessageBytes = Utils.HEX.decode("e3e1f3e86865616465" +
    ...
    public void testBitcoinPacketHeaderMaxSize() {
        ...
        byte[] maxMessageLength = Utils.HEX.decode("0000000000000000000000004062b0070000000000");
    ...
    public void testBitcoinPacketHeaderTooLong() {
        ...
        byte[] wrongMessageLength = Utils.HEX.decode("0000000000000000000000004162b0070000000000");
    ...
    public void testSeekPastMagicBytes() {
        ...
        Serializer.defaultFor(Net.MAINNET).seekPastMagicBytes(ByteBuffer.wrap(brokenMessage));
    }
    ...
    public void testSerializeUnknownMessage() throws Exception {
        MessageSerializer serializer = Serializer.defaultMainnet();
