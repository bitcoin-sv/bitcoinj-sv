...
public class TransactionTest {
    ...
    public void testCoinbaseHeightCheck() throws VerificationException {
        ...
        final byte[] transactionBytes = Utils.HEX.decode("");
    ...
    public void testCoinbaseHeightCheckWithDamagedScript() throws VerificationException {
        ...
        final byte[] transactionBytes = Utils.HEX.decode(
    ...
    public void testHashForSignature()
    {
        ...
        Transaction txConnected = new Transaction(Net.MAINNET, Utils.HEX.decode(txConnectedData));
        Transaction tx = new Transaction(Net.MAINNET, Utils.HEX.decode(txData));
