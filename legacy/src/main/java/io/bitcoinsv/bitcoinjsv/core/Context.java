...
public class Context {
     ...
     * @param ensureMinRequiredFee Whether to ensure the minimum required fee by default when completing transactions. For details, see {io.bitcoinsv.bitcoinjsv.temp.SendRequest#ensureMinRequiredFee}.
     */
    ...
    /**
     * The default fee per 1000 bytes of transaction data to pay when completing transactions. For details, see { io.bitcoinsv.bitcoinjsv.temp.SendRequest#feePerKb}.
     */
    ...
    /**
     * Whether to ensure the minimum required fee by default when completing transactions. For details, see { io.bitcoinsv.bitcoinjsv.temp.SendRequest#ensureMinRequiredFee}.
     */
