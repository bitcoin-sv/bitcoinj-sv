 ...
 * you need, these should prove useful. You can get a confidence object using {@link TxHelper#getConfidence(Transaction)}.
...
public class TransactionConfidence {
     ...
     * {io.bitcoinsv.bitcoinjsv.core.listeners.BlockChainListener}, attach it to a {@link SPVBlockChain_legacy} and then use the getters on the
