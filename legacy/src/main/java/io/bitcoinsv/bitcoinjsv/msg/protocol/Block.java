...
public class Block extends Message implements HeaderReadOnly {
     ...
     */
    public static final int MAX_BLOCK_SIZE = 1000 * 1000 * 1000;
    /**
    ...
    public Coin getBlockInflation(int height) {
        return Coin.FIFTY_COINS.shiftRight(height / net.params().getSubsidyDecreaseBlockCount());
    }
    ...
    protected void parseHeader() throws ProtocolException {
        ...
        headerParsed = true;
        headerBytesValid = serializeMode.isParseRetainMode();
    }
    ...
    protected void parseTransactions(final int transactionsOffset) throws ProtocolException {
        ...
        transactionsParsed = true;
        transactionBytesValid = serializeMode.isParseRetainMode();
    }
    ...
    protected void parseLite() throws ProtocolException {
        ...
        if (length() == UNKNOWN_LENGTH) {
            Preconditions.checkState(serializeMode.isParseLazyMode(),
            ...
            transactionBytesValid = !transactionsParsed || serializeMode.isParseRetainMode() && length() > HEADER_SIZE;
        }
        headerBytesValid = !headerParsed || serializeMode.isParseRetainMode() && length() >= HEADER_SIZE;
    }
    ...
    public void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.forceSetLength(coinbase.unsafeBitcoinSerialize().length);
    ...
    Block createNextBlock(@Nullable final Address to, final long version,
        ...
        if (to != null) {
            ...
            t.addOutput(new TransactionOutput(net, t, Coin.FIFTY_COINS, to));
    ...
    public Block createNextBlock(@Nullable Address to, TransactionOutPoint prevOut) {
        return createNextBlock(to, BitcoinJ.BLOCK_VERSION_GENESIS, prevOut, getTime() + 5, pubkeyForTesting, Coin.FIFTY_COINS, BitcoinJ.BLOCK_HEIGHT_UNKNOWN);
    }
    ...
    /**
     * Return whether this block contains any transactions attempting to lazy parse
     *
    ...
    /**
     * returns the backing list of transaction, it will not
     * attempt a lazy parse before returning and may return null
     * @return
     */
    public List<Transaction> getParsedTransactions() {
        return transactions;
    }
