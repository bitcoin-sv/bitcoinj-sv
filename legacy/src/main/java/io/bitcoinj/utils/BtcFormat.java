...
import io.bitcoinj.utils.BtcAutoFormat.Style;
import static io.bitcoinj.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link io.bitcoinj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link io.bitcoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
