...
import static io.bitcoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
 ...
 * custom pattern using either the { BtcFormat.Builder#localizedPattern} or { BtcFormat.Builder#localizedPattern} methods, as described in the documentation for the {@link BtcFormat.Builder}
 * class.<ol>
 *
