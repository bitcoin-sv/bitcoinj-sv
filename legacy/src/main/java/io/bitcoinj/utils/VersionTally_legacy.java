 ...
 */
public class VersionTally_legacy {
    /**
    ...
    public VersionTally_legacy(final NetworkParameters params) {
     ...
     */
    public void initialize(final BlockStore_legacy blockStore, final StoredBlock_legacy chainHead)
        throws BlockStoreException {
        StoredBlock_legacy versionBlock = chainHead;
