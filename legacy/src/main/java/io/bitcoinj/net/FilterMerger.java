...
/**
 * <p>A reusable object that will calculate, given a list of {@link io.bitcoinj.core.PeerFilterProvider}s, a merged
 * {@link BloomFilter} and earliest key time for all of them.
 * Used by the {@link io.bitcoinj.core.PeerGroup} class internally.</p>
 *
