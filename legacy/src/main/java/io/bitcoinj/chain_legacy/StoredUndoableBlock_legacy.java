...
import io.bitcoinj.core.TransactionOutputChanges;
 ...
 * connected.
 */
public class StoredUndoableBlock_legacy {
    ...
    public StoredUndoableBlock_legacy(Sha256Hash hash, TransactionOutputChanges txOutChanges) {
        this.blockHash = hash;
        this.transactions = null;
        this.txOutChanges = txOutChanges;
    }
    
    public StoredUndoableBlock_legacy(Sha256Hash hash, List<Transaction> transactions) {
        this.blockHash = hash;
    ...
    public boolean equals(Object o) {
        ...
        return getHash().equals(((StoredUndoableBlock_legacy)o).getHash());
    }
