...
package io.bitcoinj.temp.listener;
...
public interface WalletCoinsReceivedEventListener {
     ...
     * transaction receives its first confirmation, register a {@link io.bitcoinj.core.TransactionConfidence} event listener using
     * the object retrieved via {@link TxHelper#getConfidence(Transaction)}. It's safe to modify the
