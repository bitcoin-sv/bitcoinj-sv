...
import io.bitcoinj.chain_legacy.StoredUndoableBlock_legacy;
...
public interface FullPrunedBlockStore extends BlockStore_legacy, UTXOProvider {
    ...
    /**
     * Gets a {@link io.bitcoinj.core.UTXO} with the given hash and index, or null if none is found
     */
    UTXO getTransactionOutput(Sha256Hash hash, long index) throws BlockStoreException;
    
    /**
     * Adds a {@link io.bitcoinj.core.UTXO} to the list of unspent TransactionOutputs
     */
    void addUnspentTransactionOutput(UTXO out) throws BlockStoreException;
    
    /**
     * Removes a {@link io.bitcoinj.core.UTXO} from the list of unspent TransactionOutputs
