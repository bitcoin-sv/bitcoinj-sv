...
public abstract class ListMessage extends Message {
    ...
    public void addItem(InventoryItem item) {
        unCache();
        setLength(length() - VarInt.sizeOf(items.size()));
        items.add(item);
        setLength(length() + VarInt.sizeOf(items.size()) + InventoryItem.MESSAGE_LENGTH);
    }
    ...
    protected void parseLite() throws ProtocolException {
        ...
        setLength((int) (cursor - offset + (arrayLen * InventoryItem.MESSAGE_LENGTH)));
    }
