...
import io.bitcoinj.msg.ChildMessage;
...
public class TransactionInput extends ChildMessage {
    ...
    public TransactionInput(Net net, @Nullable Transaction parentTransaction, byte[] scriptBytes,
        ...
        setLength(40 + (scriptBytes == null ? 1 : VarInt.sizeOf(scriptBytes.length) + scriptBytes.length));
    }
    ...
    protected void parseLite() throws ProtocolException {
        ...
        setLength(cursor - offset + scriptLen + 4);
        cursor = curs;
    }
