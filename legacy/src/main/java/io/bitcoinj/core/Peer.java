...
import io.bitcoinj.net.StreamConnection;
 ...
 * {@link io.bitcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link io.bitcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link io.bitcoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link io.bitcoinj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link io.bitcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link io.bitcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link io.bitcoinj.core.Peer#ping()} has never
