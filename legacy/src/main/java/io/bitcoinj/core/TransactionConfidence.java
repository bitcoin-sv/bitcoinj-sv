 ...
 * you need, these should prove useful. You can get a confidence object using {@link io.bitcoinj.msg.protocol.TxHelper#getConfidence(Transaction)}.
 ...
 *
 * <p>TransactionConfidence is updated via the {@link io.bitcoinj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link io.bitcoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * wallet has been attached to a live {@link PeerGroup} using { PeerGroup#addWallet(Wallet)}.
         * You can estimate how likely the transaction is to be included by connecting to a bunch of nodes then measuring
         * how many announce it, using {@link io.bitcoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link io.bitcoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * {io.bitcoinj.core.listeners.BlockChainListener}, attach it to a {@link SPVBlockChain_legacy} and then use the getters on the
