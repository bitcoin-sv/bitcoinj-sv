...
public class Context {
    ...
    private Coin feePerKb = BitcoinJ.DEFAULT_TX_FEE;
    ...
    public Context(NetworkParameters params) {
        log.info("Creating bitcoinj {} context.", BitcoinJ.BITCOINJ_VERSION);
     ...
     * @param feePerKb The default fee per 1000 bytes of transaction data to pay when completing transactions. For details, see {@org.bitcoinj.wallet.SendRequest#feePerKb}.
     * @param ensureMinRequiredFee Whether to ensure the minimum required fee by default when completing transactions. For details, see {io.bitcoinj.temp.SendRequest#ensureMinRequiredFee}.
     */
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link io.bitcoinj.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link io.bitcoinj.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * The default fee per 1000 bytes of transaction data to pay when completing transactions. For details, see { io.bitcoinj.temp.SendRequest#feePerKb}.
     */
    ...
    /**
     * Whether to ensure the minimum required fee by default when completing transactions. For details, see { io.bitcoinj.temp.SendRequest#ensureMinRequiredFee}.
     */
