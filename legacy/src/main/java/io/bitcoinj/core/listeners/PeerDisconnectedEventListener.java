...
public interface PeerDisconnectedEventListener {
     ...
     * {@link io.bitcoinj.core.PeerGroup} and the group is in the process of shutting down. If this listener is registered to a
     * {@link Peer} instead of a {@link io.bitcoinj.core.PeerGroup}, peerCount will always be 0. This handler can be called without
