 ...
 */
public class ECKey implements EncryptableItem, ECKeyBytes {
    ...
    public static ECKey fromPrivateAndPrecalculatedPublic(byte[] priv, byte[] pub) {
        checkNotNull(priv);
        checkNotNull(pub);
        return new ECKey(new BigInteger(1, priv), ECDSA.CURVE.getCurve().decodePoint(pub));
    }
    ...
    public static ECKey fromPublicOnly(byte[] pub) {
        return new ECKey(null, ECDSA.CURVE.getCurve().decodePoint(pub));
    }
     ...
     * @throws io.bitcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws io.bitcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
    @Override
     ...
     * the {@link io.bitcoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
