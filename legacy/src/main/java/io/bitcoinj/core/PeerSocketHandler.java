...
import io.bitcoinj.net.AbstractTimeoutHandler;
import io.bitcoinj.net.MessageWriteTarget;
 ...
 * {@link io.bitcoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link io.bitcoinj.net.NioClient} or
     * {@link io.bitcoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
