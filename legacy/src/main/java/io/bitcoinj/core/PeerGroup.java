...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link io.bitcoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link io.bitcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link io.bitcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link io.bitcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link io.bitcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link io.bitcoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link io.bitcoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link io.bitcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link io.bitcoinj.core.Peer#ping()}.
     */
