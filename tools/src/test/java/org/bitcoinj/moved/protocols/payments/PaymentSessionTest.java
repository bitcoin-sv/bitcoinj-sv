...
import org.bitcoinj.moved.protocols.payments.PaymentProtocol;
import org.bitcoinj.moved.protocols.payments.PaymentProtocolException;
import org.bitcoinj.moved.protocols.payments.PaymentSession;
...
public class PaymentSessionTest {
    ...
    public void setUp() throws Exception {
        serverKey = new ECKey();
        tx = new Transaction(NET);
        outputToMe = new TransactionOutput(NET, tx, coin, serverKey);
    ...
    public void testSimplePayment() throws Exception {
        ...
        tx.addInput(new TransactionInput(NET, tx, outputToMe.getScriptBytes()));
        ...
        TransactionOutput refundOutput = new TransactionOutput(NET, null, coin, refundAddr);
