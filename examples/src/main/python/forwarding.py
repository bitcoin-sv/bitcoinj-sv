...
from io.bitcoinsv.bitcoinjsv.core import *

import io.bitcoinjsv.bitcoinjsv.crypto.KeyCrypterException
import io.bitcoinjsv.bitcoinjsv.params.MainNetParams
...
if __name__ == "__main__":
    params = io.bitcoinsv.bitcoinjsv.params.TestNet3Params.get()
