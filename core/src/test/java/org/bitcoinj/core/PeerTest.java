...
public class PeerTest extends TestWithNetworkConnections {
    ...
    public void invDownloadTx() throws Exception {
        ...
        Coin value = COIN;
        Transaction tx = createFakeTx(NET, value, address);
        InventoryMessage inv = new InventoryMessage(NET);
        ...
        getdata = (GetDataMessage) outbound(writeTarget);
        inbound(writeTarget, new NotFoundMessage(NET, getdata.getItems()));
    ...
    public void invDownloadTxMultiPeer() throws Exception {
        ...
        Coin value = COIN;
        Transaction tx = createFakeTx(NET, value, this.address);
        InventoryMessage inv = new InventoryMessage(NET);
        InventoryItem item = new InventoryItem(InventoryItem.Type.Transaction, tx.getHash());
        inv.addItem(item);
    ...
    public void newBlock() throws Exception {
        ...
        final InventoryMessage inv = new InventoryMessage(NET);
        InventoryItem item = new InventoryItem(InventoryItem.Type.Block, b2.getHash());
        inv.addItem(item);
    ...
    public void getLargeBlock() throws Exception {
        ...
        t.addOutput(new TransactionOutput(NET, t, Coin.ZERO, new byte[Transaction.MAX_TRANSACTION_SIZE_FOR_TESTS - 1000]));
        b2.addTransaction(t);
    ...
    public void fastCatchup() throws Exception {
        ...
        HeadersMessage headers = new HeadersMessage(NET, b2.cloneAsHeader(),
    ...
    public void recursiveDependencyDownloadDisabled() throws Exception {
        ...
        Transaction tx = FakeTxBuilder.createFakeTx(NET, COIN, address);
    ...
    public void recursiveDependencyDownload() throws Exception {
        ...
        Transaction t2 = FakeTxBuilder.createFakeTx(NET, COIN, to);
        Sha256Hash t5hash = t2.getInput(0).getOutpoint().getHash();
        Transaction t4 = FakeTxBuilder.createFakeTx(NET, COIN, new ECKey());
        ...
        t1.addInput(new TransactionInput(NET, t1, new byte[]{}, new TransactionOutPoint(NET, 0, t7hash)));
        Sha256Hash t8hash = Sha256Hash.wrap("3b801dd82f01d17bbde881687bf72bc62e2faa8ab8133d36fcb8c3abe7459da6");
        t1.addInput(new TransactionInput(NET, t1, new byte[]{}, new TransactionOutPoint(NET, 1, t8hash)));
        t1.addOutput(COIN, to);
        t1 = FakeTxBuilder.roundTripTransaction(NET, t1);
        t2 = FakeTxBuilder.roundTripTransaction(NET, t2);
        t3 = FakeTxBuilder.roundTripTransaction(NET, t3);
        t4 = FakeTxBuilder.roundTripTransaction(NET, t4);
        ...
        NotFoundMessage notFound = new NotFoundMessage(NET);
        ...
        notFound = new NotFoundMessage(NET);
    ...
    public void recursiveDependencyDownload_depthLimited() throws Exception {
        ...
        Transaction t3 = new Transaction(NET);
        t3.addInput(new TransactionInput(NET, t3, new byte[]{}, new TransactionOutPoint(NET, 0, t4hash)));
        t3.addOutput(COIN, new ECKey());
        t3 = FakeTxBuilder.roundTripTransaction(NET, t3);
    ...
    public void timeLockedTransactionNew() throws Exception {
        ...
        Transaction t1 = FakeTxBuilder.createFakeTx(NET, COIN, key);
        inbound(writeTarget, t1);
        GetDataMessage getdata = (GetDataMessage) outbound(writeTarget);
        inbound(writeTarget, new NotFoundMessage(NET, getdata.getItems()));
        pingAndWait(writeTarget);
        ...
        Transaction t2 = FakeTxBuilder.createFakeTx(NET, valueOf(2, 0), key);
    ...
    private void checkTimeLockedDependency(boolean shouldAccept) throws Exception {
        ...
        t2.addInput(new TransactionInput(NET, t2, new byte[]{}, new TransactionOutPoint(NET, 0, t3)));
    ...
    public void exceptionListener() throws Exception {
        ...
        connect();
        Transaction t1 = new Transaction(NET);
        t1.addInput(new TransactionInput(NET, t1, new byte[]{}));
        ...
        final NotFoundMessage nfm = new NotFoundMessage(NET, Lists.newArrayList(inventoryItem));
    ...
    public void getUTXOs() throws Exception {
        ...
        TransactionOutPoint op1 = new TransactionOutPoint(NET, 1, Sha256Hash.of("foo".getBytes()));
        TransactionOutPoint op2 = new TransactionOutPoint(NET, 2, Sha256Hash.of("bar".getBytes()));
        ...
        ECKey key = new ECKey();
        TransactionOutput out1 = new TransactionOutput(NET, null, Coin.CENT, key);
        UTXOsMessage response1 = new UTXOsMessage(NET, ImmutableList.of(out1), new long[]{UTXOsMessage.MEMPOOL_HEIGHT}, Sha256Hash.ZERO_HASH, 1234);
        inbound(writeTarget, response1);
        assertEquals(future1.get(), response1);

        TransactionOutput out2 = new TransactionOutput(NET, null, Coin.FIFTY_COINS, key);
        UTXOsMessage response2 = new UTXOsMessage(NET, ImmutableList.of(out2), new long[]{1000}, Sha256Hash.ZERO_HASH, 1234);
