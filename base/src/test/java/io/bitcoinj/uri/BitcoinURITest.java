...
package io.bitcoinj.uri;

import io.bitcoinj.core.AddressLite;
import io.bitcoinj.exception.BitcoinURIParseException;
...
public class BitcoinURITest {
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        assertEquals("test:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage",
             BitcoinURI.convertToBitcoinURI(AddressLite.fromBase58(alternativeParameters, MAINNET_GOOD_ADDRESS), parseCoin("12.34"), "Hello", "AMessage"));
    }
