...
import io.bitcoinsv.bitcoinjsv.crypto.EncryptedData;
...
import io.bitcoinsv.bitcoinjsv.protos.Protos.ScryptParameters;
...
public class ECKeyTest {
    ...
    public void testSignatures() throws Exception {
        ...
        // a message with it.
        BigInteger privkey = new BigInteger(1, Utils.HEX.decode("180cb41c7c600be951b5d3d0a7334acc7506173875834f7a6c4c786a28fcbb19"));
    ...
    public void testASN1Roundtrip() throws Exception {
        byte[] privkeyASN1 = Utils.HEX.decode(
        ...
        for (ECKeyLite key : new ECKeyLite[]{decodedKey, roundtripKey}) {
            byte[] message = Utils.reverseBytes(Utils.HEX.decode(
    ...
    public void testCanonicalSigs() throws Exception {
        ...
        while (in.available() > 0) {
            ...
            Assertions.assertTrue(TransactionSignature.isEncodingCanonical(Utils.HEX.decode(sig.toString())));
        }
        in.close();
    }
    ...
    public void testNonCanonicalSigs() throws Exception {
        ...
        while (in.available() > 0) {
            ...
            try {
                ...
                assertFalse(TransactionSignature.isEncodingCanonical(Utils.HEX.decode(sigStr)));
