...
public class MonetaryFormatTest {
    ...
    public void btcRounding() throws Exception {
        assertEquals("0", format(Coin.ZERO, 0, 0));
        assertEquals("0.00", format(Coin.ZERO, 0, 2));
    ...
    public void mBtcRounding() throws Exception {
        assertEquals("0", format(Coin.ZERO, 3, 0));
        assertEquals("0.00", format(Coin.ZERO, 3, 2));
    ...
    public void uBtcRounding() throws Exception {
        assertEquals("0", format(Coin.ZERO, 6, 0));
        assertEquals("0.00", format(Coin.ZERO, 6, 2));
    ...
    public void repeatOptionalDecimals() {
        assertEquals("0.00000001", formatRepeat(Coin.SATOSHI, 2, 4));
        assertEquals("0.00000010", formatRepeat(Coin.SATOSHI.multiply(10), 2, 4));
        assertEquals("0.01", formatRepeat(Coin.CENT, 2, 4));
        assertEquals("0.10", formatRepeat(Coin.CENT.multiply(10), 2, 4));

        assertEquals("0", formatRepeat(Coin.SATOSHI, 2, 2));
        assertEquals("0", formatRepeat(Coin.SATOSHI.multiply(10), 2, 2));
        assertEquals("0.01", formatRepeat(Coin.CENT, 2, 2));
        assertEquals("0.10", formatRepeat(Coin.CENT.multiply(10), 2, 2));

        assertEquals("0", formatRepeat(Coin.CENT, 2, 0));
        assertEquals("0", formatRepeat(Coin.CENT.multiply(10), 2, 0));
    }
    ...
    public void missingCode() {;
        assertThrows(NumberFormatException.class, () -> MonetaryFormat.UBTC.shift(1).format(Coin.ZERO));
    }

    @Test
    public void parse() {
        Assertions.assertEquals(Coin.COIN, NO_CODE.parse("1"));
        Assertions.assertEquals(Coin.COIN, NO_CODE.parse("1."));
        Assertions.assertEquals(Coin.COIN, NO_CODE.parse("1.0"));
        Assertions.assertEquals(Coin.COIN, NO_CODE.decimalMark(',').parse("1,0"));
        Assertions.assertEquals(Coin.COIN, NO_CODE.parse("01.0000000000"));
        Assertions.assertEquals(Coin.COIN, NO_CODE.positiveSign('+').parse("+1.0"));
        Assertions.assertEquals(Coin.COIN.negate(), NO_CODE.parse("-1"));
        Assertions.assertEquals(Coin.COIN.negate(), NO_CODE.parse("-1.0"));

        Assertions.assertEquals(Coin.CENT, NO_CODE.parse(".01"));

        Assertions.assertEquals(Coin.MILLICOIN, MonetaryFormat.MBTC.parse("1"));
        Assertions.assertEquals(Coin.MILLICOIN, MonetaryFormat.MBTC.parse("1.0"));
        Assertions.assertEquals(Coin.MILLICOIN, MonetaryFormat.MBTC.parse("01.0000000000"));
        Assertions.assertEquals(Coin.MILLICOIN, MonetaryFormat.MBTC.positiveSign('+').parse("+1.0"));
        Assertions.assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MBTC.parse("-1"));
        Assertions.assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MBTC.parse("-1.0"));

        Assertions.assertEquals(Coin.MICROCOIN, MonetaryFormat.UBTC.parse("1"));
        Assertions.assertEquals(Coin.MICROCOIN, MonetaryFormat.UBTC.parse("1.0"));
        Assertions.assertEquals(Coin.MICROCOIN, MonetaryFormat.UBTC.parse("01.0000000000"));
        Assertions.assertEquals(Coin.MICROCOIN, MonetaryFormat.UBTC.positiveSign('+').parse("+1.0"));
        Assertions.assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UBTC.parse("-1"));
        Assertions.assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UBTC.parse("-1.0"));

        Assertions.assertEquals(Coin.CENT, NO_CODE.withLocale(new Locale("hi", "IN")).parse(".०१")); // Devanagari
    }

    @Test
    public void parseInvalidEmpty() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.parse(""));
    }

    @Test
    public void parseInvalidWhitespaceBefore() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.parse(" 1"));
    }
    ...
    public void parseInvalidMultipleDecimalMarks() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.parse("1.0.0"));
    }

    @Test
    public void parseInvalidDecimalMark() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.decimalMark(',').parse("1.0"));
    }

    @Test
    public void parseInvalidPositiveSign() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.positiveSign('@').parse("+1.0"));
    }

    @Test
    public void parseInvalidNegativeSign() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.negativeSign('@').parse("-1.0"));
    }

    @Test
    public void parseInvalidHugeNumber() {
        assertThrows(NumberFormatException.class, () -> NO_CODE.parse("99999999999999999999"));
    }
