...
public class ExchangeRateTest {
    ...
    public void normalRate() {
        ...
        Assertions.assertEquals("0.002", rate.fiatToCoin(Fiat.parseFiat("EUR", "1")).toPlainString());
    }
    ...
    public void bigRate(){
        ...
        Assertions.assertEquals("0", rate.fiatToCoin(Fiat.parseFiat("BYR", "1")).toPlainString()); // Tiny value!
    }
    ...
    public void smallRate(){
        ...
        Assertions.assertEquals("10000000", rate.fiatToCoin(Fiat.parseFiat("XXX", "1")).toPlainString());
    }
