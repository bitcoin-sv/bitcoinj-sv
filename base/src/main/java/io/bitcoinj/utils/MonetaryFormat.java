...
import io.bitcoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link io.bitcoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link io.bitcoinj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
