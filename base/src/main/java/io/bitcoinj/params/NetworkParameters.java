...
import io.bitcoinj.utils.MonetaryFormat;
...
public abstract class NetworkParameters {
    ...
    /**
     * First byte of a base58 encoded address. See { io.bitcoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See { io.bitcoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {AlertMessage}s. You can use { io.bitcoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
