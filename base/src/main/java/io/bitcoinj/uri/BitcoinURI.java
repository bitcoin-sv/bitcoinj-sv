...
import io.bitcoinj.exception.OptionalFieldValidationException;
import io.bitcoinj.exception.RequiredFieldValidationException;
import io.bitcoinj.params.NetworkParameters;
import io.bitcoinj.params.AbstractBitcoinNetParams;
...
public class BitcoinURI {
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        if (!addressToken.isEmpty()) {
            ...
            try {
                AddressLite address = AddressLite.fromBase58(params, addressToken);
    ...
    public AddressLite getAddress() {
        return (AddressLite) parameterMap.get(FIELD_ADDRESS);
    }
     ...
     */
    public static String convertToBitcoinURI(AddressLite address, Coin amount,
