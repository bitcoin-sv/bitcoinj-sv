 ...
 */
public class DumpedPrivateKeyLite extends VersionedChecksummedBytes {
     ...
     */
    public static DumpedPrivateKeyLite fromBase58(@Nullable NetworkParameters params, String base58) throws AddressFormatException {
        return new DumpedPrivateKeyLite(params, base58);
    }

    // Used by ECKey.getPrivateKeyEncoded()
    DumpedPrivateKeyLite(NetworkParameters params, byte[] keyBytes, boolean compressed) {
    ...
    @Deprecated
    public DumpedPrivateKeyLite(@Nullable NetworkParameters params, String encoded) throws AddressFormatException {
        super(encoded);
    ...
    public ECKeyLite getKey() {
        final ECKeyLite key = ECKeyLite.fromPrivate(bytes);
    ...
    public boolean equals(Object o) {
        ...
        DumpedPrivateKeyLite other = (DumpedPrivateKeyLite) o;
