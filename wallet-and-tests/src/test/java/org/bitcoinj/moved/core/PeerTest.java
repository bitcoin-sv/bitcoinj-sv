...
public class PeerTest extends TestWithNetworkConnections {
    ...
    public void setUp() throws Exception {
        super.setUp();
        VersionMessage ver = new VersionMessage(TestWithNetworkConnections.NET, 100);
        InetSocketAddress address = new InetSocketAddress("127.0.0.1", 4000);
        peer = new Peer(TestWithNetworkConnections.PARAMS, ver, new PeerAddress(TestWithNetworkConnections.PARAMS, address), SPVBlockChain);
    ...
    private void connectWithVersion(int version, int flags) throws Exception {
        VersionMessage peerVersion = new VersionMessage(TestWithNetworkConnections.NET, OTHER_PEER_CHAIN_HEIGHT);
    ...
    public void chainDownloadEnd2End() throws Exception {
        ...
        Block b1 = FakeTxBuilder.createFakeBlock(blockStore, BitcoinJ.BLOCK_HEIGHT_GENESIS).block;
        ...
        Assert.assertEquals(Sha256Hash.ZERO_HASH, getblocks.getStopHash());
        ...
        inv = new InventoryMessage(TestWithNetworkConnections.NET);
        inv.addBlock(b5);
    ...
    public void invDownloadTx() throws Exception {
        ...
        Coin value = COIN;
        Transaction tx = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, value, address);
        InventoryMessage inv = new InventoryMessage(TestWithNetworkConnections.NET);
        ...
        getdata = (GetDataMessage) outbound(writeTarget);
        inbound(writeTarget, new NotFoundMessage(TestWithNetworkConnections.NET, getdata.getItems()));
    ...
    public void invDownloadTxMultiPeer() throws Exception {
        ...
        Peer peer2 = new Peer(TestWithNetworkConnections.PARAMS, ver, new PeerAddress(TestWithNetworkConnections.PARAMS, address), SPVBlockChain);
        ...
        Coin value = COIN;
        Transaction tx = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, value, this.address);
        InventoryMessage inv = new InventoryMessage(TestWithNetworkConnections.NET);
        InventoryItem item = new InventoryItem(InventoryItem.Type.Transaction, tx.getHash());
        inv.addItem(item);
    ...
    public void newBlock() throws Exception {
        ...
        final InventoryMessage inv = new InventoryMessage(TestWithNetworkConnections.NET);
        InventoryItem item = new InventoryItem(InventoryItem.Type.Block, b2.getHash());
        inv.addItem(item);
    ...
    public void getLargeBlock() throws Exception {
        ...
        SPVBlockChain.add(b1);
        Block b2 = FakeTxBuilder.makeSolvedTestBlock(b1);
        Transaction t = new Transaction(TestWithNetworkConnections.NET);
        t.addInput(b1.getTransactions().get(0).getOutput(0));
        t.addOutput(new TransactionOutput(TestWithNetworkConnections.NET, t, Coin.ZERO, new byte[Transaction.MAX_TRANSACTION_SIZE_FOR_TESTS - 1000]));
        b2.addTransaction(t);
    ...
    public void fastCatchup() throws Exception {
        ...
        HeadersMessage headers = new HeadersMessage(TestWithNetworkConnections.NET, b2.cloneAsHeader(),
    ...
    public void recursiveDependencyDownloadDisabled() throws Exception {
        ...
        Transaction tx = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, COIN, address);
    ...
    public void recursiveDependencyDownload() throws Exception {
        ...
        Transaction t2 = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, COIN, to);
        Sha256Hash t5hash = t2.getInput(0).getOutpoint().getHash();
        Transaction t4 = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, COIN, new ECKey());
        Sha256Hash t6hash = t4.getInput(0).getOutpoint().getHash();
        t4.addOutput(COIN, new ECKey());
        Transaction t3 = new Transaction(TestWithNetworkConnections.NET);
        t3.addInput(t4.getOutput(0));
        t3.addOutput(COIN, new ECKey());
        Transaction t1 = new Transaction(TestWithNetworkConnections.NET);
        t1.addInput(t2.getOutput(0));
        t1.addInput(t3.getOutput(0));
        Sha256Hash t7hash = Sha256Hash.wrap("2b801dd82f01d17bbde881687bf72bc62e2faa8ab8133d36fcb8c3abe7459da6");
        t1.addInput(new TransactionInput(TestWithNetworkConnections.NET, t1, new byte[]{}, new TransactionOutPoint(TestWithNetworkConnections.NET, 0, t7hash)));
        Sha256Hash t8hash = Sha256Hash.wrap("3b801dd82f01d17bbde881687bf72bc62e2faa8ab8133d36fcb8c3abe7459da6");
        t1.addInput(new TransactionInput(TestWithNetworkConnections.NET, t1, new byte[]{}, new TransactionOutPoint(TestWithNetworkConnections.NET, 1, t8hash)));
        t1.addOutput(COIN, to);
        t1 = FakeTxBuilder.roundTripTransaction(TestWithNetworkConnections.NET, t1);
        t2 = FakeTxBuilder.roundTripTransaction(TestWithNetworkConnections.NET, t2);
        t3 = FakeTxBuilder.roundTripTransaction(TestWithNetworkConnections.NET, t3);
        t4 = FakeTxBuilder.roundTripTransaction(TestWithNetworkConnections.NET, t4);
        ...
        NotFoundMessage notFound = new NotFoundMessage(TestWithNetworkConnections.NET);
        ...
        notFound = new NotFoundMessage(TestWithNetworkConnections.NET);
    ...
    public void recursiveDependencyDownload_depthLimited() throws Exception {
        ...
        Transaction t3 = new Transaction(TestWithNetworkConnections.NET);
        t3.addInput(new TransactionInput(TestWithNetworkConnections.NET, t3, new byte[]{}, new TransactionOutPoint(TestWithNetworkConnections.NET, 0, t4hash)));
        t3.addOutput(COIN, new ECKey());
        t3 = FakeTxBuilder.roundTripTransaction(TestWithNetworkConnections.NET, t3);
        Transaction t2 = new Transaction(TestWithNetworkConnections.NET);
    ...
    public void timeLockedTransactionNew() throws Exception {
        ...
        Wallet wallet = new Wallet(TestWithNetworkConnections.PARAMS);
        ...
        Transaction t1 = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, COIN, key);
        inbound(writeTarget, t1);
        GetDataMessage getdata = (GetDataMessage) outbound(writeTarget);
        inbound(writeTarget, new NotFoundMessage(TestWithNetworkConnections.NET, getdata.getItems()));
        pingAndWait(writeTarget);
        ...
        Transaction t2 = FakeTxBuilder.createFakeTx(TestWithNetworkConnections.NET, valueOf(2, 0), key);
    ...
    private void checkTimeLockedDependency(boolean shouldAccept) throws Exception {
        ...
        t2.addInput(new TransactionInput(TestWithNetworkConnections.NET, t2, new byte[]{}, new TransactionOutPoint(TestWithNetworkConnections.NET, 0, t3)));
    ...
    public void exceptionListener() throws Exception {
        ...
        connect();
        Transaction t1 = new Transaction(TestWithNetworkConnections.NET);
        t1.addInput(new TransactionInput(TestWithNetworkConnections.NET, t1, new byte[]{}));
        t1.addOutput(COIN, new ECKey().toAddress(TestWithNetworkConnections.PARAMS));
        Transaction t2 = new Transaction(TestWithNetworkConnections.NET);
        ...
        final NotFoundMessage nfm = new NotFoundMessage(TestWithNetworkConnections.NET, Lists.newArrayList(inventoryItem));
    ...
    public void getUTXOs() throws Exception {
        ...
        TransactionOutPoint op1 = new TransactionOutPoint(TestWithNetworkConnections.NET, 1, Sha256Hash.of("foo".getBytes()));
        TransactionOutPoint op2 = new TransactionOutPoint(TestWithNetworkConnections.NET, 2, Sha256Hash.of("bar".getBytes()));
        ...
        ECKey key = new ECKey();
        TransactionOutput out1 = new TransactionOutput(TestWithNetworkConnections.NET, null, Coin.CENT, key);
        UTXOsMessage response1 = new UTXOsMessage(TestWithNetworkConnections.NET, ImmutableList.of(out1), new long[]{UTXOsMessage.MEMPOOL_HEIGHT}, Sha256Hash.ZERO_HASH, 1234);
        inbound(writeTarget, response1);
        assertEquals(future1.get(), response1);

        TransactionOutput out2 = new TransactionOutput(TestWithNetworkConnections.NET, null, Coin.FIFTY_COINS, key);
        UTXOsMessage response2 = new UTXOsMessage(TestWithNetworkConnections.NET, ImmutableList.of(out2), new long[]{1000}, Sha256Hash.ZERO_HASH, 1234);
    ...
    public void badMessage() throws Exception {
        ...
        serializer.serialize("inv", new InventoryMessage(TestWithNetworkConnections.NET) {
            @Override
