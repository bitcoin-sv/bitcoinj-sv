...
public class PaymentProtocolTest {
    ...
    public void setUp() throws Exception {
        InputStream is = getClass().getResourceAsStream("test-cacerts");
        caStore = X509Utils.loadKeyStore("JKS", "password", is);
    ...
    public void testSignAndVerifyValid() throws Exception {
        ...
        // Verify
        PaymentProtocol.PkiVerificationData verificationData = PaymentProtocol.verifyPaymentRequestPki(paymentRequest.build(), caStore);
    ...
    public void testPaymentRequest() throws Exception {
        ...
        final List<PaymentProtocol.Output> parsedOutputs = parsedPaymentRequest.getOutputs();
